...
export class StatisticService extends JpHttpServiceAbstract {
  public async getNutzungsstatistiken (params: StatisticParams): Promise<AxiosResponse<DtOStatistic[]>> {
    return await axios.post<DtOStatistic[]>(this.GetConfig().statisticUrl + 'usageStatistic/', params)
  }
}
